...
from PyQt6.QtWidgets import (
    ...
    QFileDialog, QStatusBar, QFrame, QScrollArea, QGridLayout
)
...
class CleanupWidget(QWidget):
    ...
    def run_cleanup(self):
        ...
        self.output.append(f"Backup option: {self.backup_group.checkedId()}\n")
        ...
        # Note: In production, we'd need to handle the interactive backup prompt
        # For now, we'll document that the script needs modification for GUI use
